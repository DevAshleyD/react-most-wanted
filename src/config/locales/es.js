...
const messages = defineMessages({
  ...
  warning_404_description: 'Lo sentimos, pero la página que buscas no existe.',
  settings: 'Ajustes',
  language: 'Idioma',
  theme: 'Tema',
  ...
  delete_company_title: '¿Eliminar compañía?',
  delete_company_message: '¡La compañía será eliminada!',
  ...
  private: 'Privado',
  public: 'Público',
  grant_read_companies: 'Leer compañías',
  grant_create_company: 'Crear compañías',
  grant_edit_company: 'Editar compañías',
  grant_delete_company: 'Borrar compañías',
  ...
  delete_predefined_chat_message_message: '¡El mensaje predefinido será borrado!',
